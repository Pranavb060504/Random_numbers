...
&P(Y=y|X=1)P(X=1)=\frac{1}{2} P(Y=5+N)\\
&=\frac{1}{2}\brak{\frac{1}{\sqrt{2 \pi}} e^{\frac{-(y-5)^2}{2}}}\\
&\therefore P_{X|Y}(x|y) \big|_{X=1}=\frac{\frac{1}{2}\brak{\frac{1}{\sqrt{2 \pi}} e^{\frac{-(y-5)^2}{2}}}}{P(Y=y)}\\
