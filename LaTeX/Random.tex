...
&P_e=f(\delta)\\
&\text{to maximize} P_e, \frac{d(f(\delta))}{d\delta}=0\\
...
$\because p_{X}(0)=p \\
 \therefore p_{X}(1)=1-p$
 \begin{align}
 &P_{e}=p P(e|s_0)+(1-p)P(e|s_1)=p Q(1+\delta)+(1-p)Q(1-\delta)\\
 &\frac{d(P_{e}){d\delta}=0\\
 &\implies (1-p)e^{\frac{-(1-\delta)^{2}}{2}}-(1-p)e^{\frac{-(1+\delta)^{2}}{2}}=0\\
 &=e^\frac{(1+\delta)^{2}-(1-\delta)^{2}}{2}=\frac{p}{1-p}\\
 \end{align}
